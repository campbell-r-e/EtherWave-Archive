...
- User registration and JWT-based authentication (username only — no email required)
...
- [Docker Engine 24+](https://docs.docker.com/engine/install/) with Compose v2 plugin
...
- Click "Register here"
- Create your account (username and password — no email required)
- Create a logbook
- Start logging QSOs
...
┌─────────────────────────────────────────────────────────────┐
│                         Frontend                             │
│  Angular 21.2.0 Standalone Components + Bootstrap 5.3       │
...
### Authentication
- `POST /api/auth/register` - Register new user (username + password, no email required)
...
- **Issues**: https://github.com/campbell-r-e/EtherWave-Archive/issues
